...
fn make_book_1_final_scene() -> Scene {
    ...
    use crate::raytracer::shape::sphere::*;
    ...
    let sph = scene.add_shape(UnitSphere.into());

    // ground
    {
        let m = scene.add_material(Lambertian::new(Color::from_rgb(0.5, 0.5, 0.5)).into());
